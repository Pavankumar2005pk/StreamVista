...
function MovieDetailsModal({ movieId, onClose, onSelectMovie }) {
        ...
        {loading ? (
          ...
          <>
            <div className="modal__header">
              {backdrop && <img src={backdrop} alt="" className="modal__backdrop" />}
              <div className="modal__header-content">
                <h1 className="modal__title">{data.title} {year && `(${year})`}</h1>
                <div className="modal__meta">
                  {rating && <span>{rating} Rating</span>}
                  {data.runtime && <span>{Math.floor(data.runtime / 60)}h {data.runtime % 60}m</span>}
                  {isAdult && <span>{isAdult}</span>}
            ...
            <div className="modal__body">
              <div className="modal__poster">
                <img src={poster || 'https://via.placeholder.com/300x450/1a1a1a/cccccc?text=No+Poster'} alt={data.title} />
              </div>
              <div className="modal__details">
                ...
                <div className="mdetail__field">
                  <div className="mdetail__label">Genres</div>
                  <div className="mdetail__value">{genres.join(', ')}</div>
                </div>
                ...
                {collection && !collectionLoading && (
                  <div className="modal__collection">
                    <h3 className="modal__collection-title">
                      Part of the {collection.name} Collection
